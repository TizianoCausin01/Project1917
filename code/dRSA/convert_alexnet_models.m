layers = ["real_conv_layer1", "real_conv_layer4", "real_conv_layer7", "real_conv_layer9", "real_conv_layer11", "real_fc_layer2", "real_fc_layer5"];
...
for irun = 1:3
    ...
    for ilayer = 1:length(layers)
        mod2load=sprintf("%sProject1917_real_alexnet_run%02d.h5", mod_dir, irun)
        ...
        fn2save =sprintf("%sProject1917_real_alexnet_%s_run%02d_movie24Hz.mat", mod_dir, layers(ilayer), irun);
